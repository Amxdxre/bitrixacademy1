...
<div class="wrap">
    <div class="hd_header_area">
        <div class="hd_header">
            <table>
                <tr>
                    ...
                    <td rowspan="2" class="hd_txarea">
                        ...
                        <?php echo GetMessage('WORKING_TIME'); ?> <span class="workhours">ежедневно с 9-00 до 18-00</span>
                    </td>
            ...
            <div class="nv_topnav">
                <ul>
                    <li><a class="menu-img-fon" style="background-image: url(/local/templates/main/images/nv_home.png);"
                           href="/"><span></span></a></li>
